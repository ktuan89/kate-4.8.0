...
class KateConsole : public KVBox, public Kate::XMLGUIClient
{
  ...
  Q_SIGNALS:
    void signalReceiveLine(const QString & line);
  ...
  public Q_SLOTS:
    ...
    // send "arc build" to terminal
    void slotArcBuild();
    void slotGccCompile();
    void slotRunWithInput();
...
class PluginKonsoleDialog: public KDialog {
    Q_OBJECT
    public:
        PluginKonsoleDialog(QWidget *parent, const QLinkedList<QString> & rlist, KateConsole * console);
        virtual ~PluginKonsoleDialog();
        static QString document(QWidget *parent, const QLinkedList<QString> & rlist, KateConsole * console);
    protected:
