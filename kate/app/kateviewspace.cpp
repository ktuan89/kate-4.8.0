    ...
    m_viewSpace( parent )
{
  ...
  m_alphabetaMode = new QLabel( "", this );
  addWidget( m_alphabetaMode, 0 );
  m_alphabetaMode->setAlignment( Qt::AlignCenter );
  m_alphabetaMode->installEventFilter( this );

  m_switchCheckbox = new QCheckBox( "", this);
  addWidget( m_switchCheckbox, 0);
  // m_switchCheckbox->setAlignment( Qt::AlignCenter );
  // m_switchCheckbox->installEventFilter( this );
  m_switchCheckbox->setChecked(true);
