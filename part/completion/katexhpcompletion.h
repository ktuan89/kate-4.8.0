...
#ifndef _KateXHPCompletion_h_
#define _KateXHPCompletion_h_
...
class KateXHPCompletionModel : public KTextEditor::CodeCompletionModel, public KTextEditor::CodeCompletionModelControllerInterface4
{
  Q_OBJECT
  Q_INTERFACES(KTextEditor::CodeCompletionModelControllerInterface4)
  public:
    KateXHPCompletionModel( QObject *parent );
    ~KateXHPCompletionModel();
