...
#ifndef _KateNewCompletion_h_
#define _KateNewCompletion_h_
...
class KateNewCompletionModel : public KTextEditor::CodeCompletionModel, public KTextEditor::CodeCompletionModelControllerInterface4
{
  Q_OBJECT
  Q_INTERFACES(KTextEditor::CodeCompletionModelControllerInterface4)
  public:
    KateNewCompletionModel( QObject *parent );
    ~KateNewCompletionModel();
