                 ...
                 public KTextEditor::CoordinatesToCursorInterface
{
  ...
  Q_SIGNALS:
    void signalToggleAlphaBetaMoveMode();

  public Q_SLOTS:
    void updateAlphaBetaMoveMode(bool b);
    void emitToggleAlphaBetaMoveMode() {
      emit signalToggleAlphaBetaMoveMode();
    }
...
public:
  ...
  private:
      ...
      // ktuan
      QList<QKeySequence> getDoubleShortcut(QKeySequence q1, QKeySequence q2) {
        QList<QKeySequence> res;
        res << q1 << q2;
        return res;
      }

      QList<QKeySequence> getDoubleShortcut(QKeySequence q1) {
        QList<QKeySequence> res;
        res << q1;
        return res;
      }

      QList<QKeySequence> getDoubleShortcut(QKeySequence q1, QKeySequence q2, QKeySequence q3) {
        QList<QKeySequence> res;
        res << q1 << q2 << q3;
        return res;
      }
