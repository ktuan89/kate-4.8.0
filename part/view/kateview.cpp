...
void KateView::setupActions()
{
  ...
  a = ac->addAction("view_inc_font_sizes_with_strategy");
  a->setIcon(KIcon("zoom-in"));
  a->setText(i18n("Enlarge Font with strategy"));
  a->setWhatsThis(i18n("This increases the display font size with strategy."));
  connect(a, SIGNAL(triggered(bool)), m_viewInternal, SLOT(slotIncFontSizesWithStrategy()));

  a = ac->addAction("view_inc_font_weight");
  a->setIcon(KIcon("zoom-in"));
  a->setText(i18n("Enlarge Font Weight"));
  connect(a, SIGNAL(triggered(bool)), m_viewInternal, SLOT(slotIncFontWeight()));

  a = ac->addAction("view_dec_font_weight");
  a->setIcon(KIcon("zoom-out"));
  a->setText(i18n("Shrink Font Weight"));
  connect(a, SIGNAL(triggered(bool)), m_viewInternal, SLOT(slotDecFontWeight()));

  a = ac->addAction("view_show_font_info");
  a->setIcon(KIcon("zoom-out"));
  a->setText(i18n("Show Font Info"));
  connect(a, SIGNAL(triggered(bool)), m_viewInternal, SLOT(slotShowFontInfo()));

  a = ac->addAction("view_toggle111");
  a->setIcon(KIcon("zoom-out"));
  a->setText(i18n("m_Antialiasing"));
  connect(a, SIGNAL(triggered(bool)), m_viewInternal, SLOT(slotToggle111()));

  a = ac->addAction("view_toggle222");
  a->setIcon(KIcon("zoom-out"));
  a->setText(i18n("m_TextAntialiasing"));
  connect(a, SIGNAL(triggered(bool)), m_viewInternal, SLOT(slotToggle222()));

  a = ac->addAction("view_toggle333");
  a->setIcon(KIcon("zoom-out"));
  a->setText(i18n("m_SmoothPixmapTransform"));
  connect(a, SIGNAL(triggered(bool)), m_viewInternal, SLOT(slotToggle333()));

  a = ac->addAction("view_toggle444");
  a->setIcon(KIcon("zoom-out"));
  a->setText(i18n("m_HighQualityAntialiasing"));
  connect(a, SIGNAL(triggered(bool)), m_viewInternal, SLOT(slotToggle444()));
...
void KateView::setupEditActions()
{
  ...
  a->setShortcuts(getDoubleShortcut(
      QKeySequence(Qt::Key_Home),
      QKeySequence(Qt::META + Qt::Key_Left)
                                   ));
  ...
  a->setShortcuts(getDoubleShortcut(
      ...
      QKeySequence(Qt::SHIFT + Qt::META + Qt::Key_Left)
                                  ));
  ...
  a->setShortcuts(getDoubleShortcut(
      QKeySequence(Qt::SHIFT + Qt::CTRL + Qt::Key_Home),
      QKeySequence(Qt::SHIFT + Qt::META + Qt::Key_BracketLeft)
      // QKeySequence(Qt::SHIFT + Qt::CTRL + Qt::META + Qt::Key_Left)
                                  ));
  ...
  a->setShortcuts(getDoubleShortcut(
      ...
      QKeySequence(Qt::META + Qt::Key_Right)
                                   ));
  ...
  a->setShortcuts(getDoubleShortcut(
      ...
      QKeySequence(Qt::SHIFT + Qt::META + Qt::Key_Right)
                                  ));
  ...
  a->setShortcuts(getDoubleShortcut(
      QKeySequence(Qt::SHIFT + Qt::CTRL + Qt::Key_End),
      QKeySequence(Qt::SHIFT + Qt::META + Qt::Key_BracketRight)
                                  ));
  ...
  a->setShortcuts(getDoubleShortcut(
      ...
      // QKeySequence(Qt::CTRL + Qt::SHIFT + Qt::META + Qt::Key_Up)
                                  ));
  ...
  a->setShortcuts(getDoubleShortcut(
      ...
      // QKeySequence(Qt::CTRL + Qt::SHIFT + Qt::META + Qt::Key_Down)
                                  ));
...
void KateView::updateAlphaBetaMoveMode(bool b) {
  m_viewInternal->m_alphabetamode = b;
}

bool KateView::alphaBetaMoveMode() const {
  return m_viewInternal->m_alphabetamode;
}
...
void KateView::updateConfig ()
{
  ...
  unregisterCompletionModel (KateGlobal::self()->xhpCompletionModel());
  registerCompletionModel (KateGlobal::self()->xhpCompletionModel());
