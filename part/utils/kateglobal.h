...
class KateNewCompletionModel;
class KateXHPCompletionModel;
...
class KATEPART_TESTS_EXPORT KateGlobal : public KTextEditor::Editor, public KTextEditor::CommandInterface, public KTextEditor::ContainerInterface, public KTextEditor::TemplateScriptRegistrar
{
  ...
  public:
    ...
    KateNewCompletionModel *newCompletionModel () { return m_newCompletionModel; }
    KateXHPCompletionModel *xhpCompletionModel() { return m_xhpCompletionModel; }
  ...
  private:
    ...
    KateNewCompletionModel *m_newCompletionModel;

    KateXHPCompletionModel *m_xhpCompletionModel;
};
