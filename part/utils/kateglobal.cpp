 ...
 , m_componentData (&m_aboutData)
{
  ...
  m_newCompletionModel = new KateNewCompletionModel (this);
  m_xhpCompletionModel = new KateXHPCompletionModel (this);
}
...
KateGlobal::~KateGlobal()
{
  ...
  delete m_newCompletionModel;
  delete m_xhpCompletionModel;
