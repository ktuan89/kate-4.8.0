...
public:
    ...
    void increaseFontSizesWithStrategy();
  ...
  // ktuan
private:
  bool m_Antialiasing, m_TextAntialiasing, m_SmoothPixmapTransform,
    m_HighQualityAntialiasing;

public:
  void toggleAntialiasing() {
    m_Antialiasing = !m_Antialiasing;
  }
  void toggleTextAntialiasing() {
    m_TextAntialiasing = !m_TextAntialiasing;
  }void toggleSmoothPixmapTransform() {
    m_SmoothPixmapTransform = !m_SmoothPixmapTransform;
  }void toggleHighQualityAntialiasing() {
    m_HighQualityAntialiasing = !m_HighQualityAntialiasing;
  }
};
